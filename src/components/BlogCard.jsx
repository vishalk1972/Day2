...
export default function ({img,likes,time,text}) {
  return (
    <div className='flex items-center'>
        <div className='w-96'>
            <div className='h-80 w-full rounded-tl-xl overflow-hidden '>
                <img className='h-full' src={img} alt=''></img>
            </div>
            <div className='flex w-96 justify-between items-center translate-y-1'>

                <p className='text-l text-gray-400 mt-1'>{time}</p>

                <div className='flex text-l  text-gray-400 mt-1 items-center'>
            ...
            <div className='mt-1 translate-y-3 w-96'>
